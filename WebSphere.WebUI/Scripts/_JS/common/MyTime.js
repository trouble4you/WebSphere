...
function GetDatetimeFromDateUTC(dt) {
    if (dt == null)
        return 0;
...
{
    var d1 = new Date(Date.UTC(2001, 0, 1, 0, 0, 0));
...
function GetDateLabel(sec)
{
    ...
    // Возвращает дату в текстовом виде: 2001-02-03 04:05:06
    var d1 = new Date(Date.UTC(2001, 0, 1, 0, 0, 0));
    var d = new Date(d1.getTime() + sec * 1000);
    var r = "";
    if (d.getDate() < 10) r += "0";
...
function GetDateLabel2(sec)
{
    // Принимает количество секунд с начала века
    // Возвращает дату в текстовом виде: 2001-02-03 04:05:06
    var d1 = new Date(Date(2001, 0, 1, 0, 0, 0));
    var d = new Date(d1.getTime() + sec * 1000);
    var r = "";
    r += d.getFullYear() + "-";
    if (d.getMonth() < 10) r += "0";
